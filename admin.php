...
<body id="top">
    ...
    <section id="contact" class="section text-center">
        <div class="container">
            <h2 class="section-title">admin QUEUE - full management</h2>
                <div class="row">

                <!-- LIST QUEUE -->
                    <div class="contact-info text-left wow fadeInRight" data-wow-duration="1s" data-wow-delay=".3s">
						<h3>ADMIN LIST - <a href="desk.php">CLick to view current list</a></h3>
                        <style>th {
...
if ($row["Seen"] == 0) {
	...
	<tr>
	  ...
	  <td><?php echo $Seen; ?></td>
	  <td><?php echo $row["SeenBy"]; ?></td>
	  <td><?php echo $row["SeenAt"]; ?></td>
